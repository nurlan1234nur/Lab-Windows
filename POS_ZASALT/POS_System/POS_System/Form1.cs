...
namespace POS_System
{
    public partial class Form1 : Form
    {
        ...
        public List<Order> ReceiptItems = new List<Order>();
            ...
            if (columnName == "Plus" || columnName == "Minus")
            {
                ...
                if (columnName == "Plus")
                {
                    ...
                    foreach (var item in ReceiptItems)
                    {
                        ...
                        {
                            item.Quantity = qty;
                            item.TotalPrice = TotalAll;
                        }
                    }

                }
                else if (columnName == "Minus" && qty > 0)
                {
                    qty = qty - 1;
                    TotalAll = TotalAll - price;
                    foreach (var item in ReceiptItems)
        ...
        {
            Form paymentForm = new Payment(TotalAll, ReceiptItems);
